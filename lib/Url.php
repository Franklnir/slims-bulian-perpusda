...
class Url
{
    ...
    public static function getScheme()
    {
        ...
        if (self::$forceHttps || $urlConfig) return 'https://';

        // php built-in server and some reverse proxies may not provide REQUEST_SCHEME.
        ...
        if (!empty($_SERVER['HTTP_X_FORWARDED_PROTO'])) {
            ...
            if (in_array($proto, ['http', 'https'], true)) return $proto . '://';
        }
